...
class TrainRetriever:
    ...
    def __init__(self, model: SentenceTransformer, batch_size: int = 64,asym:bool =False ):
        self.model = model
    ...
    def load_ir_evaluator(self, corpus: Dict[str, Dict[str, str]], queries: Dict[str, str], 
        ...
        return InformationRetrievalEvaluator(queries, corpus ,rel_docs, name=name,write_csv= True,asym=self.asym)
